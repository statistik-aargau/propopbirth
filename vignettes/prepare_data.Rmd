...
+---------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **population data** | Historical population records of females in a pre-defined age range ('fertile age', often 15 to 49) aggregated per spatial unit, year, age, and nationality. | -   `year` e.g. 2010 to 2023 for the FSO's birth data                                                                                                             |
|                     |                                                                                                                                                              |                                                                                                                                                                   |
|                     |                                                                                                                                                              | -   `spatial_unit` one (e.g. Canton) or several (e.g. municipalities) spatial units                                                                               |
|                     |                                                                                                                                                              |                                                                                                                                                                   |
...
data("fso_pop", package = "propopbirth")
```
